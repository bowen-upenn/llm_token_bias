    ...
    with torch.no_grad():
        ...
        for n in tqdm(range(args['datasets']['num_synthetic_examples'])):
            ...
            for i, curr_new_question in enumerate(new_questions):
                ...
                write_response_to_json(n, response_dict, synthetic_data_filename,
                                       fallacy_type=fallacy_type, generation_mode=generation_mode, linda_problem_variant=linda_problem_variant)
