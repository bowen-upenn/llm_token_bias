...
🍎**10-07-2024** Apple's trending paper [GSM-Symbolic: Understanding the Limitations of Mathematical Reasoning in Large Language Models](https://arxiv.org/pdf/2410.05229v1) references our work multiple times. It generalizes  mathematical reasoning problems into symbolic templates, and questions the genuine reasoning capabilities of LLMs. Definitely worth checking out both!
