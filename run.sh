...
for i in "${!prompting_methods[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES="$gpu_id" python main.py --model llama --task inference --eval_mode "${prompting_methods[$i]}" --data_file synthetic_dataset_linda_variant_four_gold.json --verbose &
done
